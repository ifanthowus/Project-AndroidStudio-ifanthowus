...
public class Beasiswa_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beasiswa_page);
        list = new ArrayList<>();
        list.add(new ItemClass(R.drawable.loker1, "INTERSHIP", "The Legal and Finance teams are pivotal in ensuring that the company is kept compliant, accountable, and primed for success with the right checks and balances. Browse our Legal and Finance team openings to see how you can make an impact with us.\n" +
                "\n" +
                "Deskripsi Pekerjaan:\n \n" +
        ...
        list.add(new ItemClass(R.drawable.loker2, "John", "John@email.com"));
        list.add(new ItemClass(R.drawable.loker3, "Ian", "Ian@email.com"));
        ...
        adapter.OnRecyclerViewClickListener(new MyAdapter1.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(int position) {
                ...
                Intent intent = new Intent(Beasiswa_page.this, Detail_beasiswa.class);
