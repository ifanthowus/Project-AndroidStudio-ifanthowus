...
public class Magang_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magang_page);
        //--> Creating a list
        list = new ArrayList<>();
        ...
        adapter.OnRecyclerViewClickListener(new MyAdapter1.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(int position) {
                ...
                Intent intent = new Intent(Magang_page.this, Detail_loker.class);
